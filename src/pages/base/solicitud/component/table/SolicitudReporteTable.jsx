    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) => {
                ...
                if (record.estado === 'A') {
                    // Para anulaciones, el motivo suele estar en observaciones según DeleteSolicitud.controller.js
                ...
                <tbody>
                    {loading ? (
                        ...
                        solicitudes?.map((row, idx) => (
                            <tr key={row.cod_solicitud || idx} style={{ borderBottom: '1px solid #f5f5f5' }}>
                                {columns.map(col => (
