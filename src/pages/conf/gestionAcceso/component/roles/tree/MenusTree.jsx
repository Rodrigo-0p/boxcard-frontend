...
const MenusTree = ({ menus, checkedKeys, onCheck, loading }) => {
    ...
    return (
        <Main.Spin spinning={loading} tip="Cargando permisos...">
            <div style={{ 
                padding: '24px', 
                background: '#fff', 
                ...
                <div style={{ marginBottom: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span style={{ fontSize: '12px', color: '#8c8c8c', fontWeight: 500 }}>ESTRUCTURA DE NAVEGACIÓN</span>
