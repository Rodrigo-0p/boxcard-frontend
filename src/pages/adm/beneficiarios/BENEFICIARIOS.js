...
// COMPONENTS
import BeneficiariosHeader from './component/header/BeneficiariosHeader';
import BeneficiariosToolbar from './component/toolbar/BeneficiariosToolbar';
import BeneficiariosCards from './component/cards/BeneficiariosCards';
import BeneficiariosModal from './component/modal/BeneficiariosModal';
import CargaMasivaModal from './component/modal/CargaMasivaModal';

import MainLayout from '../../../components/layout/MainLayout';
import './styles/BENEFICIARIOS.css';
...
const BENEFICIARIOS = () => {
    ...
    const [pageSize, setPageSize] = React.useState(12); // Aumentado para cards
    ...
    const handleDescargarModelo = async () => {
        try {
            ...
            // Sólo los campos equivalentes al registro manual
            const wsData = [
            ...
            // Forzar tipo texto en Documento (A) y RUC (B) para que Excel no los convierta
    ...
    // (el import masivo ahora lo maneja CargaMasivaModal)
    ...
    const handleExportar = async () => {
        try {
            ...
            // Usar aoa_to_sheet para controlar tipos de celda
            ...
            // Forzar texto en columna Documento (B) y RUC (C) para todos los datos
    ...
    const beneficiariosPaginados = beneficiariosFiltrados.slice(startIndex, endIndex);
